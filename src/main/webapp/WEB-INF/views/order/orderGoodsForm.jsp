...
function fn_show_order_detail(){
	//결제타입 확인하기
	let payType = document.querySelector("input[name='pay_method']:checked").value;
	
	//카카오 페이로 왔을 때
	if(payType == '카카오페이(간편결제)'){
		
		//화면에서 가져갈 데이터 
		let amount = document.querySelector("#h_each_goods_price").value; //결제금액
		let itemName = document.querySelector("#h_goods_title").value; //상품명
		let userName = document.querySelector("#h_orderer_name").value; //구매자
...
// 					주문요청 후 응답 받은 데이터를 form에 넣음 
					document.querySelector("input[name='ordr_idxx']").value = data.ordr_idxx;
					document.querySelector("input[name='good_name']").value = data.good_name;
					document.querySelector("input[name='good_mny']").value = data.good_mny;
					document.querySelector("input[name='buyr_name']").value = data.buyr_name;
					document.querySelector("input[name='site_cd']").value = data.site_cd;
...
function fn_process_pay_order(){
	...
	let cardPw = document.querySelector("#cardPw");
	...
	<div class="detail_table">
		<table>
			<tbody>
				<tr >
					<td>
					   <input type="radio" class="pay_method" name="pay_method" value="신용카드"   onClick="fn_pay_card()" checked>신용카드 &nbsp;&nbsp;&nbsp; 
					   <input type="radio" class="pay_method" name="pay_method" value="제휴 신용카드"  >제휴 신용카드 &nbsp;&nbsp;&nbsp; 
					   <input type="radio" class="pay_method" name="pay_method" value="실시간 계좌이체">실시간 계좌이체 &nbsp;&nbsp;&nbsp;
					   <input type="radio" class="pay_method" name="pay_method" value="무통장 입금">무통장 입금 &nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr >
					<td>
					   <input type="radio" class="pay_method" name="pay_method" value="휴대폰결제" onClick="fn_pay_phone()">휴대폰 결제 &nbsp;&nbsp;&nbsp;
					   <input type="radio" class="pay_method" name="pay_method" value="카카오페이(간편결제)">카카오페이(간편결제) &nbsp;&nbsp;&nbsp; 
					   <input type="radio" class="pay_method" name="pay_method" value="페이나우(간편결제)">페이나우(간편결제) &nbsp;&nbsp;&nbsp; 
					   <input type="radio" class="pay_method" name="pay_method" value="페이코(간편결제)">페이코(간편결제) &nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr >
					<td>
					   <input type="radio" class="pay_method" name="pay_method" value="직접입금">직접입금&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr id="tr_pay_card">
					<td>
				...
				<tbody align=left>
				   ...
				   <tr>
					...
					<tr>
						...
						<td align=left>
							<input type="text" id="cardPw" name="cardPw">
						</td>
					</tr>
				   <tr>
